SET 
@base_dir = 'C:\\Inetpub\\vhosts\\raptorads.com\\SolarICO.raptorads.com',
@base_url = 'http://solarico.raptorads.com',
@site_name = 'SolarMine', 
@curl_enabled = 'false', 
@mail_server = 'mail.raptorads.com',
@mail_user = 'support@raptorads.com',
@mail_pw = 'jzhG296&', 
@mail_security = '', 
@mail_port = '25',
@sa_user = 'natsoon',
@sa_id = '9097599ef92ec2dc1',
@sa_email = 'natsoon@raptorads.com', 
@sa_password = '$2y$10$aE8jrJF5FAke5964p1np/ORwarB3snVyJPXFBnLLccmQiA890zrzS',
@time_zone = 'UTC';
